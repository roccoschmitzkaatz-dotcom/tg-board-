...
5. Add `supabase-repository.js` against `BACKEND_BRIEF.md`.
6. Migrate Auth/profile and the V1 forum first.
7. Add Helpful, announcements, DMs, notifications, moderation and files in separate pull requests.
